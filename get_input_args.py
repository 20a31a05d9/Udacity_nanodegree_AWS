...
def get_input_args():
    ...
    # Creates 3 command line arguments args.dir for path to images            # args.arch which CNN model to use for classification, args.lab to text file with names of dogs.
